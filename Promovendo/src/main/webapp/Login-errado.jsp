...
<body>
            ...
            <div class="form">
                <div class="trabalhe-conosco">
                    <form action="login.html" method="get">
                        <h1 id="titlle-cofirm">Erro ao Logar</h1>
                        
                        <img src="img/errado-login.webp" id= "check-login" alt="Login fall">

                        <button type="submit" class="btn-comum" id="btn-enviar-banco">Tentar novamente</button>
    ...
    <footer>
        ...
        <div class="informacoes-finais">
            ...
            <P>SIGA Área Especial para Indústria Lote 2/3, Sce St. Leste Industrial - Gama, Brasília - DF, CEP 72445-020
            </p>
